  ...
  return (
    <div className="space-y-6 animate-pulse">
      <div className="space-y-1">
        <div className="h-8 w-40 rounded-lg bg-slate-700" />
      ...
      <div className="flex gap-6">
        ...
        <aside className="hidden lg:block w-72 shrink-0">
          <div className="rounded-xl border border-slate-700 bg-slate-800 p-5 shadow-sm space-y-5">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="space-y-2">
                <div className="h-3 w-20 rounded bg-slate-700" />
                <div className="h-9 w-full rounded-md bg-slate-700" />
              </div>
            ))}
          </div>
        </aside>
        ...
        <div className="flex-1 grid grid-cols-1 xl:grid-cols-2 gap-4">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="rounded-xl border border-slate-700 bg-slate-800 p-5 space-y-4">
