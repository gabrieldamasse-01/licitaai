...
export function MobileHeader({ email, userId }: { email: string; userId: string }) {
  ...
  return (
    <header className="flex h-14 shrink-0 items-center justify-between border-b border-white/5 bg-white px-4 md:px-6 shadow-sm z-30 sticky top-0 md:hidden">
      {/* Brand logo */}
      <div className="flex items-center gap-2">
        ...
        <span className="text-[15px] font-bold text-slate-900 tracking-tight">Licita<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-violet-400">IA</span></span>
      </div>
